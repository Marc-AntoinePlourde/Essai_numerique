...
delta_t = 0.0000000002 # pas de temps entre et dans les dés en secondes
...
listex = []
for i in range(len(liste_periodes)):
    listex.append(i + 1)

plt.plot(listex, liste_periodes, "r")
plt.xlabel("Nombre de tours effectués")
